...
export const metadata: Metadata = {
  ...
  title: "Compras",
  description: "Administra tus compras de YourMarket",
}
    ...
    try {
      const data = await tx
        .select({
          ...
          status: orders.paykuPaymentIntentStatus,
        ...
        .where(
          and(
            ...
            // Filter by status
            statuses.length > 0
              ? inArray(orders.paykuPaymentIntentStatus, statuses)
              : undefined
          )
        )
        .orderBy(
  ...
  return (
    <Shell variant="sidebar">
      <PageHeader
        ...
        separated
      >
        <PageHeaderHeading size="sm">Compras</PageHeaderHeading>
